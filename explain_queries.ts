...
async function main() {
  ...
  try {
    ...
    // ─── Query 2: Fully Optimized Blogs Trending Query ───
    console.log("Analyzing Query 2: Fully Optimized Blogs Trending Query...");
    const blogsExplain = await pool.query(`
      ...
      LIMIT 30 OFFSET 0
    `);
    console.log("Fully Optimized Blogs Explain Plan:");
    console.log("===================================");
