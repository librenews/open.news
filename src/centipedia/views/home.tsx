...
function StoryCard({ story, domain }: { story: LongformStory; domain: string }) {
  ...
  // Use pre-computed externalUrl, or fall back to centipedia reader for Leaflet
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="An agentic encyclopedia built collaboratively by humans and AI on the AT Protocol." />
