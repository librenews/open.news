            ...
            <div class="center-header">
              {query ? (
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                  ...
                  <a href={`/feed/search.xml?q=${encodeURIComponent(query)}`} title="RSS feed for this search" style="display: flex; align-items: center; color: var(--text-muted); transition: color 0.15s;" onmouseover="this.style.color='#f26522'" onmouseout="this.style.color='var(--text-muted)'">
