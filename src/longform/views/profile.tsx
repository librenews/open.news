        ...
        <div class="profile-layout">
          ...
          <div class="profile-header">
            ...
            <div class="profile-info">
              ...
              <div class="profile-handle">@{author.handle}</div>
          ...
          <h2 class="profile-stories-title">Published Stories</h2>

          {stories.length === 0 ? (
            <div class="empty-profile">
              <p>No long-form stories published yet.</p>
            </div>
          ) : (
            stories.map((s) => {
              const rkey = s.uri.split('/').pop();
              const readUrl = (s.site && s.path && s.site.startsWith('http'))
                ? `${s.site}${s.path}`
