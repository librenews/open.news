                ...
                <div class="story-item" style="flex-direction: column;">
                  ...
                  <div style="display: flex; align-items: center; justify-content: space-between; width: 100%; margin-top: 0.5rem;">
                    ...
                    <div style="display: flex; gap: 0.5rem; color: var(--text-muted);">
                      ...
                      <button onclick={`handleListAction(this, 'repost', '${s.authorDid}', '${rkey}', '${(s.title || '').replace(/'/g, "\\'")}')`} style="background: none; border: none; cursor: pointer; color: inherit; padding: 0; display: flex; align-items: center; transition: color 0.15s; margin-left: 0.25rem;" onmouseover="if(!this.dataset.active) this.style.color='#20d070'" onmouseout="if(!this.dataset.active) this.style.color='inherit'" title="Share on Bluesky">
