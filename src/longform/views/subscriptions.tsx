...
export function SubscriptionsPage({ subscriptions, domain, profile, feedToken }: SubscriptionsPageProps) {
  return html`
    <style>
      .subs-container {
        max-width: 680px;
    ...
    <div class="subs-container">
      <div class="subs-header">
        ...
        <div style="display: flex; align-items: center; gap: 0.75rem;">
          ...
          <a href="${feedToken ? `/feed/following.xml?token=${feedToken}` : '/feed/following.xml'}" title="RSS feed — Following" style="display: flex; align-items: center; color: var(--text-muted); transition: color 0.15s;" onmouseover="this.style.color='#f26522'" onmouseout="this.style.color='var(--text-muted)'">
