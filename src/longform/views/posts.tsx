        ...
        <div id="items-list" style="display: flex; flex-direction: column; gap: 0; min-height: 120px;">
          ...
          ${items.map(item => html`
            <div data-status="${item.status}" class="post-item" style="display: flex; align-items: center; justify-content: space-between; padding: 1rem 0; border-bottom: 1px solid rgba(0,0,0,0.06);">
              ...
              ${item.status === 'published' ? html`
                <a href="/?doc=${encodeURIComponent(item.documentName)}" title="Edit" style="background: none; border: none; cursor: pointer; color: var(--text-muted); padding: 0.5rem; margin-left: 0.25rem; transition: color 0.15s; display: flex; align-items: center; text-decoration: none;" onmouseover="this.style.color='var(--text-main)'" onmouseout="this.style.color='var(--text-muted)'">
