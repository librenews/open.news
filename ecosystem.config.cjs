  ...
  apps: [
    {
      ...
      env: { ...envVars, OTEL_SERVICE_NAME: 'open-news-web', DB_POOL_MAX: '10' },
    ...
    },
    {
      ...
      instances: 1, autorestart: true, watch: false,
      max_memory_restart: '256M',
      env: { ...envVars, LONGFORM_PORT: '4500', LONGFORM_DOMAIN: 'longform.social', DB_POOL_MAX: '10' },
    ...
    },
    {
      ...
      instances: 1, autorestart: true, watch: false,
      max_memory_restart: '256M',
      env: { ...envVars, CENTIPEDIA_PORT: '4600', CENTIPEDIA_DOMAIN: 'centipedia.org', OTEL_SERVICE_NAME: 'centipedia', DB_POOL_MAX: '10' },
    ...
    },
    {
      ...
      instances: 1, autorestart: true, watch: false,
      max_memory_restart: '256M',
      env: { ...envVars, NEARBY_PORT: '4700', NEARBY_DOMAIN: 'nearby.at', DB_POOL_MAX: '10' },
    ...
    },
    {
      ...
      instances: 1, autorestart: true, watch: false,
      max_memory_restart: '256M',
      env: { ...envVars, BLOGS_PORT: '4800', BLOGS_DOMAIN: 'blogs.social', DB_POOL_MAX: '10' },
